...
class PINNResultsWriter:
    ...
    def write_json_report(self, 
        ...
        print(f"✅ PINN results successfully written to {filename}")
        return filename
    ...
    def write_from_state(self, state: GraphState) -> GraphState:
        ...
        if not expert_comment or not loss_weights:
            ...
            print(f"   expert_comment: {'present' if expert_comment else 'missing'}")
            print(f"   loss_weights: {'present' if loss_weights else 'missing'}")
            return state
    ...
    def print_summary(self, state: GraphState):
        ...
        print(f"   initial_boundary_conditions_loss_weight: {loss_weights.initial_boundary_conditions_loss_weight}")
        print(f"   peak_height_loss_weight: {loss_weights.peak_height_loss_weight}")
        print(f"   slow_growth_penalty_weight: {loss_weights.slow_growth_penalty_weight}")
        print(f"   rapid_growth_penalty_weight: {loss_weights.rapid_growth_penalty_weight}")
